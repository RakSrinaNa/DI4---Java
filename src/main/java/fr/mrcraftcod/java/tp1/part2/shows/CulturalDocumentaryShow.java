...
/**
 * Represents a cultural documentary.
 * <p>
 ...
 * @since 2018-04-19
 */
public class CulturalDocumentaryShow extends Show implements ReportageShowType
{
	 ...
	 */
	public CulturalDocumentaryShow(String name, int length, String theme)
	{
		super(name, length);
		this.theme = theme;
	}
